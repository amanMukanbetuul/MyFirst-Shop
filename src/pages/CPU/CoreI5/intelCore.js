...
import styles from "./intelCore.module.css";
import {LazyLoadImage} from "react-lazy-load-image-component";

const IntelCore = () => {

    const {shoes,addShoesInCart, cart, deleteShoesInCart, postFavourites, favourites, delFavourites,getIntelCore} = useContext(CustomContext);
    ...
    return (
        <section>
            ...
            <div className={styles.action}>
                <h2 className={styles.title}>Intel i3, i5, i7, i9</h2>
