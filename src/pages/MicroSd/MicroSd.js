...
import styles from './MicroSd.module.css'


const MicroSd = () => {

    const {getMicroSd, shoes, addShoesInCart, cart, deleteShoesInCart, postFavourites, favourites, delFavourites} = useContext(CustomContext);
