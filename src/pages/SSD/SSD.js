...
import styles from './SSD.module.css'


const Ssd = () => {

    const { shoes, addShoesInCart, cart, deleteShoesInCart, postFavourites, favourites, delFavourites,getSSD} = useContext(CustomContext);
