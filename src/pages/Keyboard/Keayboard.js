...
const Keayboard = () => {
    ...
    const {getKeyboard, shoes, addShoesInCart, cart, deleteShoesInCart, postFavourites, favourites, delFavourites} = useContext(CustomContext);
