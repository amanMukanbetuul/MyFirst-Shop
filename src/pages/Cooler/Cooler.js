...
import styles from './Cooler.module.css'


const Cooler = () => {

    const {getCooler, shoes, addShoesInCart, cart, deleteShoesInCart, postFavourites, favourites, delFavourites} = useContext(CustomContext);
    ...
    return (
        <section>
            ...
            <div className={styles.action}>
                <h2 className={styles.title}>Куллеры</h2>
